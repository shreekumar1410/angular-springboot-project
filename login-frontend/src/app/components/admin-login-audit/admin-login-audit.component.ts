// ng g component components/admin-login-audit
...
@Component({
  selector: 'app-admin-login-audit',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './admin-login-audit.component.html',
  styleUrls: ['./admin-login-audit.component.css']
})
export class AdminLoginAuditComponent implements OnInit {
